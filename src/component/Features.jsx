              ...
              <div className="p-6">
                ...
                <div className="mt-6">
                  <div className="flex justify-center space-x-4">
                    <button
                      type="button"
                      className="text-white hover:text-purple-700 bg-gradient-to-br from-blue-500 to-black hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5"
                    >
                      1 7.5
                    </button>
                    <button
